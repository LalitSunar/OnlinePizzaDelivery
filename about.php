      ...
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown mb-0">Lalit Sunar</h2><p>CE084 <a href="https://github.com/LalitSunar?tab=projects" target="_blank">@lalitsunar</a></p>
                <a href="index.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Get Started</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.1s">
            <div class="member">
              ...
              <div class="member-info">
                ...
                <div class="social">
                  <a href="https://twitter.com/?lang=en" target="_blank"><i class="icofont-twitter"></i></a>
                  <a href="https://github.com/LalitSunar?tab=projects" target="_blank"><i class="fab fa-github"></i></a>
                  <a href="https://www.linkedin.com/feed/" target="_blank"><i class="icofont-linkedin" target="_blank"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.2s">
            <div class="member">
              ...
              <div class="member-info">
                ...
                <div class="social">
                  <a href="https://twitter.com/?lang=en"><i class="icofont-twitter" target="_blank"></i></a>
                  <a href="https://github.com/LalitSunar?tab=projects" target="_blank"><i class="fab fa-github"></i></a>
